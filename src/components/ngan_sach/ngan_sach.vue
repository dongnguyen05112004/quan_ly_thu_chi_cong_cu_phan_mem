<template>
    <div >
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <p class="mt-3"><i class="me-1"></i> Chi Tiêu <span class="float-end"></span></p>
                                        <div class="progress" style="height: 5px;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-7">
                                <div class="d-flex gap-3 mt-3">
                                    <a href="#" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#them" >Thêm</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#sua">Chỉnh sửa ngân sách</a>
                    <a href="#" class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#xoa">Xóa ngân sách</a>
                </div>
            </div>
            <div class="col-lg-4"></div>
        </div>
